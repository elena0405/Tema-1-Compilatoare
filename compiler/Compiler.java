...
import cool.lexer.*;
import cool.parser.*;
import cool.AST.CreateParseTree;
import cool.AST.CreateASTTree;
...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // TODO Print tree
        var parseTree = new CreateParseTree();
        var astTree = new CreateASTTree();
        var ast = parseTree.visit(globalTree);
        System.out.println(ast.accept(astTree));
    }
}
